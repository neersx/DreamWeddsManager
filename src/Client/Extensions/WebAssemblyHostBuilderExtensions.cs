...
using DreamWeddsManager.Client.Infrastructure.Authentication;
using DreamWeddsManager.Client.Infrastructure.Managers;
using DreamWeddsManager.Client.Infrastructure.Managers.Preferences;
...
using DreamWeddsManager.Client.Infrastructure.Managers.ExtendedAttribute;
using DreamWeddsManager.Domain.Entities.ExtendedAttributes;
using DreamWeddsManager.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace DreamWeddsManager.Client.Extensions
{
