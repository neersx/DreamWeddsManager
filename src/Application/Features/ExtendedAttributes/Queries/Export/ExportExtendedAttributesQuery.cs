...
using DreamWeddsManager.Application.Specifications.ExtendedAttribute;
...
namespace DreamWeddsManager.Application.Features.ExtendedAttributes.Queries.Export
{
