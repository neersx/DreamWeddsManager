...
namespace DreamWeddsManager.Infrastructure.Migrations
{
    ...
    [Migration("20230303153540_MetaTagsMigration")]
    partial class MetaTagsMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DreamWeddsManager.Domain.Entities.DreamWedds.BlogComments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DreamWeddsManager.Domain.Entities.DreamWedds.MetaTags", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DreamWeddsManager.Domain.Entities.DreamWedds.TemplateComments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DreamWeddsManager.Domain.Entities.DreamWedds.TemplateMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DreamWeddsManager.Domain.Entities.KeyValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DreamWeddsManager.Domain.Entities.DreamWedds.BlogComments", b =>
                {
                    b.HasOne("DreamWeddsManager.Domain.Entities.DreamWedds.Blog", "Blog")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("DreamWeddsManager.Domain.Entities.DreamWedds.MetaTags", b =>
                {
                    ...
                    b.HasOne("DreamWeddsManager.Domain.Entities.DreamWedds.TemplateMaster", "Template")
                        .WithMany("MetaTags")
            ...
            modelBuilder.Entity("DreamWeddsManager.Domain.Entities.DreamWedds.OrderDetail", b =>
                {
                    ...
                    b.HasOne("DreamWeddsManager.Domain.Entities.DreamWedds.TemplateMaster", "TemplateMaster")
                        .WithMany("OrderDetails")
