...
using DreamWeddsManager.Server.Extensions;
using DreamWeddsManager.Server.Middlewares;
using Hangfire;
...
using System.IO;
using DreamWeddsManager.Server.Filters;
using DreamWeddsManager.Server.Managers.Preferences;
using Microsoft.Extensions.Localization;

namespace DreamWeddsManager.Server
{
