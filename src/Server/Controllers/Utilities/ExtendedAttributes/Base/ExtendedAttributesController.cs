...
using DreamWeddsManager.Application.Features.ExtendedAttributes.Commands.Delete;
...
namespace DreamWeddsManager.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
