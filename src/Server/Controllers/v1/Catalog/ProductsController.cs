...
using DreamWeddsManager.Application.Features.Products.Commands.Delete;
using DreamWeddsManager.Application.Features.Products.Queries.Export;
using DreamWeddsManager.Application.Features.Products.Queries.GetAllPaged;
using DreamWeddsManager.Application.Features.Products.Queries.GetProductImage;
using DreamWeddsManager.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Threading.Tasks;

namespace DreamWeddsManager.Server.Controllers.v1.Catalog
{
